  ...
  return (
    <section id="desc">
      <header className="mb-6">
        ...
        <div className="w-3/4 grid gap-2 sm:grid-rows-2 sm:grid-flow-col">
          <div>
      ...
      <div className="my-6 flex flex-col gap-8">
        <div>
          ...
          <p className="text-light text-base/loose">
            ...
            Non beatae rem impedit iusto mollitia, veritatis tenetur voluptatum odit autem,
            eaque id nisi facilis dignissimos repudiandae dolore ea, quasi vero accusamus
            iure nemo! Maiores iste dolores repudiandae error, delectus facere
            voluptas voluptate temporibus, vitae enim quas ab laudantium
            suscipit quasi nesciunt!
          </p>
        </div>
        <div>
          ...
          <section>
            <ul className="ps-4 list-disc list-outside text-light">
              ...
              <li className="mb-2">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ex, possimus.</li>
