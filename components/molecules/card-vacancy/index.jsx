...
export default function CardVacancy({ id, position, create_date, duration, start_internship  }) {
  return (
    <div className="w-72 sm:w-80 px-2 pt-9 pb-6 rounded-xl bg-slate-50 drop-shadow-md">
      ...
      <div className="text-left ps-1 mb-4">
        <h4 className="text-dark text-2xl/tight font-semibold capitalize">{ position }</h4>
        <h6 className="text-light text-sm/tight font-light">Dibuat {create_date}</h6>
      </div>
      <div className="text-left ps-1 mb-4">
        <h6 className="text-light text-sm/tight font-light">Periode magang</h6>
        <h4 className="text-dark text-base/tight font-semibold">{ duration }</h4>
      </div>
      <div className="text-left ps-1 mb-4">
        <h6 className="text-light text-sm/tight font-light">Mulai magang</h6>
        <h4 className="text-dark text-base/tight font-semibold">{start_internship}</h4>
      </div>
